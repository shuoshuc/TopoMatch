...
tm_tree_t *kpartition_build_tree_from_topology(tm_topology_tree_t *topology,double **comm, int N, double max_val, int *constraints, int nb_constraints, double *obj_weight, double *com_speed);
